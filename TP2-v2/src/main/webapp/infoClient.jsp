...
<div class="container">
    ...
    <table>
        ...
        <tr>
            <td><%= client != null ? client.getNom() : "" %></td>
            <td><%= client != null ? client.getPrenom() : "" %></td>
            <td><%= client != null ? client.getTelephone() : "" %></td>
            <td><%= client != null ? client.getEmail() : "" %></td>
        </tr>
    </table>
